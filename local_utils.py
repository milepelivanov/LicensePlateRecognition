...
def reconstruct(I, Iresized, Yr, lp_threshold):
    ...
    if len(final_labels):
        ...
        for _, label in enumerate(final_labels):
            ...
            translation_matrix = np.array([[1, 0, 120], [0, 1, 0], [0, 0, 1]])
            scale_factor = 0.8  # You can adjust this factor as needed
            scaling_matrix = np.array([[scale_factor, 0, 0], [0, 1, 0], [0, 0, 1]])

            # Combine translation and scaling matrices
            H = np.dot(scaling_matrix, np.dot(translation_matrix, H))
